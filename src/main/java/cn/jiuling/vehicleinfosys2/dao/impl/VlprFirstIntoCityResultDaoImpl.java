...
@Repository("vlprFirstIntoCityResultDao")
public class VlprFirstIntoCityResultDaoImpl extends BaseDaoImpl<VlprFirstIntoCityResult> implements VlprFirstIntoCityResultDao {
        ...
        Pager pager = super.getHibernateTemplate().execute(new HibernateCallback<Pager>() {
            ...
            public Pager doInHibernate(Session session) throws HibernateException, SQLException {
                ...
                StringBuilder sb = new StringBuilder("select v.license,v.plateType,v.plateColor," +
                        ...
                        "from vlpr_first_intocity_result v ").append(sbJoin);
                ...
                StringBuilder subSelect = new StringBuilder("SELECT v.id FROM vlpr_first_intocity_result v ").append(sbJoin);

                StringBuilder sbOrder = new StringBuilder(" ORDER BY v.id DESC ");
				...
				*/
                ...
                StringBuilder sbAnd = new StringBuilder(" AND v.id<=");
                ...
                StringBuilder subOrder = new StringBuilder(" ORDER BY v.id " + order + " LIMIT " + limitNum + ",1");
                _firstResult = 0;
    ...
    @Override
    public Long countQuery(VlprFirstIntoCityResult vlprFirstIntoCityResult) {
        StringBuilder sb = new StringBuilder("from VlprFirstIntoCityResult vir where vir.license='" + vlprFirstIntoCityResult.getLicense()
                + "' and vir.resultTime='");
        sb.append( vlprFirstIntoCityResult.getResultTime() + "'");
