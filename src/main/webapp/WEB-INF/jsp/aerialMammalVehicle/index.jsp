...
<div class="easyui-layout" fit="true" style="width:100%;height:100%;">
    <div data-options="region:'north',split:false" style="width:100%;height:5%;background: rgb(238, 238, 238);">
        <div id="aerialMammalVehicle_toolbar">
...
<script>
    (function($){
        ...
        var aerialMammalVehicle_datagrid = tab.find("#aerialMammalVehicle_datagrid");
        var toolbar = tab.find("#aerialMammalVehicle_toolbar");
        var aerialMammalVehicle_detail_datagrid = tab.find("#aerialMammalVehicle_detail_datagrid");
        var $form = toolbar.find("form");
        var pictureServerHost = '${PictureServerHost}/';

        var startTime = $('#aerialMammalVehicle_toolbar #startTime').datetimebox({
            required: true,
            editable: false
        });
        var endTime = $('#aerialMammalVehicle_toolbar #endTime').datetimebox({
            required: true,
            editable: false
        });
        ...
        tab.on('click','#query',function(e){
            ...
            if($form.form('validate')) {
                ...
                var loadData = function(callback){
                    var aerialMammal_datagrid = aerialMammalVehicle_datagrid.datagrid({
                        url: '/aerialMammalVehicle/queryAerialMammalVehicle.action',
                        loadMsg: '数据载入中',
                        rownumbers: true,
                        fit: true,
                        singleSelect: true,
