...
<div id="cc" class="easyui-layout" style="width:100%;height:100%;">
    <div id="scarch_query_win"
         style="position: relative; width: 100%; height: 100%;"></div>

    <div id="distinguish" data-options="region:'south',title:'检索结果&ensp;&ensp;&ensp;当前检索进度：0% ',split:true" style="height:300px;">
        <div id="retrieval_results"></div>
    </div>
    ...
    <div data-options="region:'center',title:'原始图片（左）与目标图片（右）'" style="background:#eee;">
        <div id="img_original" style="width: 50%;height: 100%;float: left;"></div>
        <div id="img" style="width: 50%;height: 100%;float: right;"></div>
    </div>
</div>

<%-- 没有任何结果时用 --%>
<script type="tmpl" id="wu_vlpr_vfm_result_original_tmpl">
...
<script type="tmpl" id="vlpr_vfm_result_original_tmpl">
<div style="position:relative;left:40px;float: left;">
     <table class="info_table" style="margin:0 auto;">
        <tr>
            <td colspan="3">原始图片详情</td>
...
<script type="tmpl" id="vlpr_vfm_result_originals_tmpl">
<div>
    <div class="box-small">
...
<script>
    (function ($) {
        var wu_vlpr_vfm_result_original_tmpl = $('#wu_vlpr_vfm_result_original_tmpl').html();

        var vlpr_vfm_result_original_tmpl = $('#vlpr_vfm_result_original_tmpl').html();
        var vlpr_vfm_result_originals_tmpl = $('#vlpr_vfm_result_originals_tmpl').html();
        ...
        var $bk_task_datagrid = $('#bk_task_datagrid'),
                $bk_result_datagrid = $('#retrieval_results');
        ...
        var refresh = function () {
            setTimeout(function () {
                if ($bk_result_datagrid.data('datagrid')) {
                    ...
                    $.post("/serachCarByImage/originallisttaskid.action",{'taskID':soucheida},function (data){
                        var title = "检索结果&ensp;&ensp;&ensp;当前检索进度：" +  data.rows[0].progress + "% "
                        $('#distinguish').panel('setTitle', title);
