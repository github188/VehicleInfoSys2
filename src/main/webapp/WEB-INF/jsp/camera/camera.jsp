...
<div id="cameraManage" class="easyui-layout" fit=true>
<%--	<div region="north" style="height:100px;min-width: 1000px;" split=true>
    ...
    <div title="监控点" region="west" style="width: 220px;" split="true">
        <jsp:include page="tree.jsp"></jsp:include>
    </div>
	<div title="资源管理" region="center">
		<div id="resource_tabs" class="easyui-tabs" data-options="tabPosition:'left',headerWidth:100" fit=true border=false>
			...
			<div title="实时图片源">
				<jsp:include page="../resource/realImage.jsp"></jsp:include>
			</div>
			<%--<div title="批量识别">
...
<script>
    (function($){
        ...
        function collapsePanel(region){
            tab.find("#cameraManage").layout("collapse",region);
        }
        $.parser.onComplete = function(){
            if(${camera.status==0}) {
                tab.find(".easyui-linkbutton").linkbutton({disabled:true});
            }
            collapsePanel("west");
        }
    })(jQuery)
