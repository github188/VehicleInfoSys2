...
<script>
    (function ($) {
        ...
        var loadResultDatas = function ( pageNumber, callback, id) {
            $bk_result_datagrid.datagrid({
                ...
                columns: [[
                    ...
                    {
                        field: 'vehicleBrand', title: '品牌', width: 100
                    },
                    {
                        field: 'vehicleSeries', title: '车系', width: 100
                    },
                    {
                        field: 'vehicleStyle', title: '款型', width: 100
                    },
                    ...
                    {field: 'sun', title: '遮阳板', width: 80, formatter: util.formateSun},

                    {field: 'drop', title: '挂饰', width: 50, formatter: util.formateCharacteristic},
                    {
                        field: 'location', title: '过车地点', width: 180
                    },
        ...
        $bk_task_datagrid.datagrid({
            multiple: true,
            url: '/surveillance/queryPracticeTaskList.action',
            pagination: true,
            rownumbers: true,
            singleSelect: true,
            checkOnSelect: false,
            ...
            columns: [[
                ...
                {field: 'doTime', title: '开始时间', width: 150, formatter: util.formateTime},
                ...
                },
                {
                    ...
                    var html = '<a href="javascript:void(0)" id="' + rowId + '" class="easyui-linkbutton" data-options="iconCls:\'icon-cancel\'" >详情</a>';
